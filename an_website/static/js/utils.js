...
return newUrl;}
w.onpopstate=(event)=>{if(event.state&&event.state["stateType"]&&w.PopStateHandlers[event.state["stateType"]]){w.PopStateHandlers[event.state["stateType"]](event);w.lastLocation=w.location;return;}
