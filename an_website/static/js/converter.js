...
"use strict";(()=>{let bigIntType="bigint";try{BigInt(69);}catch(e){BigInt=Number;bigIntType="number";}
...
function onSubmit(event){event.preventDefault();for(const feld of fields)
...
field.value=field.placeholder;elById("form").onsubmit=onSubmit;})();
// @license-end
