...
"use strict";function startQuotes(){const nextButton=elById("next");const upvoteButton=elById("upvote");const downvoteButton=elById("downvote");const reportButton=elById("report");const thisQuoteId=[elById("top").getAttribute("quote-id")];const nextQuoteId=[nextButton.getAttribute("quote-id")];const params=w.location.search;const keys=(()=>{let k=new URLSearchParams(params).get("keys");if(!(k&&k.length))
