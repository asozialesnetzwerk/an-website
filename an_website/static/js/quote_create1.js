...
"use strict";(()=>{const realAuthors={};for(const child of elById("quote-list").children){realAuthors[child.value.toLowerCase()]=child.attributes.getNamedItem("data-author").value;}
