...
loaded++;};}
(()=>{const startButton=elById("start-button-no_3rd_party");if(startButton){const contentContainer=elById("comic-content-container");startButton.onclick=()=>{startButton.remove();contentContainer.classList.remove("hidden");startLoadingComics();};contentContainer.classList.add("hidden");}else{startLoadingComics();}})();
// @license-end
