...
FONT: Final = ImageFont.truetype(font=_FONT_BYTES, size=50)
FONT_SMALLER: Final = ImageFont.truetype(font=_FONT_BYTES, size=44)
HOST_NAME_FONT: Final = ImageFont.truetype(font=_FONT_BYTES, size=23)
